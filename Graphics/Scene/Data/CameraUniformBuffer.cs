...
public class CameraUniformBuffer : IDisposable
{
    ...
    public CameraUniformBuffer(GraphicsDevice gd)
    {
        ...
        _buffer = factory.CreateBuffer(new BufferDescription((uint)Marshal.SizeOf<CameraUniform>(), BufferUsage.UniformBuffer | BufferUsage.Dynamic));
        
        _layout = factory.CreateResourceLayout(new ResourceLayoutDescription(new ResourceLayoutElementDescription("ViewProjection", ResourceKind.UniformBuffer, ShaderStages.Vertex)));
